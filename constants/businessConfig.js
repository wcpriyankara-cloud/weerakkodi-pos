...
export const BUSINESS_TYPES = {
  quarry:        { id: 'quarry',        icon: '🪨', color: '#f59e0b', bg: '#fffbeb', si: 'ගල් කඩනුව',        en: 'Stone Quarry' },
  cropFarm:      { id: 'cropFarm',      icon: '🌿', color: '#16a34a', bg: '#f0fdf4', si: 'බෝග ගොවිපල',       en: 'Crop Farm' },
  vehicleRepair: { id: 'vehicleRepair', icon: '🔧', color: '#3b82f6', bg: '#eff6ff', si: 'වාහන අලුත්වැඩියා', en: 'Vehicle Repair' },
  tyreShop:      { id: 'tyreShop',      icon: '⭕', color: '#8b5cf6', bg: '#f5f3ff', si: 'ටයර් වැඩ',         en: 'Tyre Shop' },
  vehicleWash:   { id: 'vehicleWash',   icon: '🚿', color: '#06b6d4', bg: '#ecfeff', si: 'වාහන සෝදනය',       en: 'Vehicle Wash' },
  custom:        { id: 'custom',        icon: '🏢', color: '#64748b', bg: '#f8fafc', si: 'වෙනත්',           en: 'Custom Business' },
};
...
export const BIZ_COLORS = [
  ...
  '#2563eb','#7c3aed','#c026d3','#e11d48','#64748b','#0f172a',
];
